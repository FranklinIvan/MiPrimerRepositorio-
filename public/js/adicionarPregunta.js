...
function anadirRespy(id){
    var elemento = document.getElementById("resp_"+id);

    elemento.innerHTML = '<div class="alert alert-success" role="alert">'+
    '<h8>La respuesta ha sido actualizada correctamente</h8></div>'

    nuevo.appendChild(elemento);
}
...
/* function eliminarResp(id){
    ...
    '<h8>La respuesta ha sido eliminada correctamente</h8></div>'
} */
